Feature: To test purchase eletronics feature

  @Regression
  Scenario Outline: Verify purchase eletronics
    Given Verify eletronics tab is displayed "<Email>" and "<Password>"
    When User clicks on eletronics
    Then Verify eletronics page is displayed
    And User clicks on camera/photo
    Then Verify camera/photo page is displayed
