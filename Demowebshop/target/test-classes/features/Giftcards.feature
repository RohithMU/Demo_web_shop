Feature: To test purchase giftcards feature

  @Regression
  Scenario Outline: Verify purchase giftcards
    Given Verify giftcards tab is displayed "<Email>" and "<Password>"
    When User clicks on giftcards
    Then Verify giftcards page is displayed
    And User clicks on giftcards
    Then Verify giftcards page is displayed
    ...
    And User clicks on add to cart
    Then Verify giftcards added to cart
