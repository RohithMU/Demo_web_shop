Feature: To test purchase jewelary feature

  @Regression
  Scenario Outline: Verify purchase jewelary
    Given Verify giftcards tab is displayed "<Email>" and "<Password>"
    When User clicks on jewelary
    Then Verify jewelary page is displayed
    And User clicks on jewelary
    Then Verify jewelary page is displayed
    ...
    And User clicks on add to cart
    Then Verify jewelary added to cart
