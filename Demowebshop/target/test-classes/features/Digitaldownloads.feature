Feature: To test purchase digitaldownloads feature

  @Regression
  Scenario Outline: Verify purchase digitaldownloads
    Given Verify books tab is displayed "<Email>" and "<Password>"
    When User clicks on digitaldownloads
    Then Verify digitaldownloads page is displayed
    ...
    Then Verify digitaldownloads is added to cart
